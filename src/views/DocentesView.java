...
public class DocentesView {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(visible) {
					...
					crear.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent e) {
							opciones_panel.setVisible(false);
							DocentesView.this.crear(addScaled);
						}
					});
					...
					editar.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent e) {
							opciones_panel.setVisible(false);
							DocentesView.this.editar(addScaled);
						}
					});
	...
	public void detalles(Consumer<JComponent> addScaled) {
		...
		JLabel titulo = new JLabel("DETALLES");
	...
	public void crear(Consumer<JComponent> addScaled) {
		remover();
		addScaled.accept(opciones_panel);
		mipanel.add(opciones_panel);
		...
		JLabel titulo = new JLabel("CREAR");
		titulo.setHorizontalAlignment(JLabel.CENTER);
		titulo.setFont(new Font("SansSerif", Font.PLAIN, 98));
		titulo.setBounds(476, 272, 590, 387);
		addScaled.accept(titulo);
